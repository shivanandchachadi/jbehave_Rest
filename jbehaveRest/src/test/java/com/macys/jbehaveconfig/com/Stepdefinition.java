...
public class Stepdefinition {
	...
	public void givenAStorageLocationRoomuriIsDefinedthereAreZeroBinsDefined(String uri) throws Exception {
		int initial_bin=0;
		req.get(uri);
		logger.info("API requset has been sent");
		db_query="select count(*) from bin;";
		obj.bdconnection(db_result, db_query);
	...
	public void whenUserPassesuser_idroom_idAndNumberOfbinsToAddAs100(String userid,String rows) {
		// PENDING
	...
	public void thenTheSystemWillInsert100RowsbinsIntoTheBINTable() throws SQLException {
	...
	public void thenPassAMessageBackIndicatingThat100BinsrowsAreDefined() {
	...
	//second scenario adding bins to existing bins
	...
	// third scenario Adding zero bins 
	...
	//5th scenario- verifying by sending invalid room id
